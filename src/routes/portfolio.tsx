...
const PROJECTS: Project[] = [
  ...
  { title: "Medivue Health", category: "Healthcare", industry: "Healthcare", tech: ["Next.js", "Postgres", "AWS"], desc: "Patient portal for booking, records and telehealth consultations.", result: "22% fewer no-shows", img: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=1200&q=80&auto=format&fit=crop" },
  { title: "Estate Prime", category: "Real Estate", industry: "Real Estate", tech: ["Next.js", "Mapbox", "Sanity"], desc: "Real estate listings with map search, saved properties and agent CRM.", result: "45% more listings viewed", img: "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=1200&q=80&auto=format&fit=crop" },
  { title: "Saffron Table", category: "Restaurant", industry: "F&B", tech: ["WordPress", "WooCommerce"], desc: "Restaurant site with reservations, menus and online ordering.", result: "5x online orders", img: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=1200&q=80&auto=format&fit=crop" },
  { title: "Byte Academy", category: "Education", industry: "EdTech", tech: ["Next.js", "Stripe", "Postgres"], desc: "Online courses platform with progress tracking and cohort programs.", result: "12K+ enrolled students", img: "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=1200&q=80&auto=format&fit=crop" },
  { title: "Urban Threads", category: "Ecommerce", industry: "Fashion", tech: ["Shopify", "Liquid", "Klaviyo"], desc: "Custom Shopify store with 2x conversion after a full redesign.", result: "2.1x conversion rate", img: "https://images.unsplash.com/photo-1557821552-17105176677c?w=1200&q=80&auto=format&fit=crop" },
  { title: "SalesHub CRM", category: "CRM", industry: "SaaS", tech: ["React", "Node", "Postgres"], desc: "Sales CRM with pipeline automation and email sequencing.", result: "40% more deals closed", img: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&q=80&auto=format&fit=crop" },
  { title: "PeopleFlow HRM", category: "HRM", industry: "Enterprise", tech: ["Laravel", "MySQL", "React"], desc: "HRM platform with payroll, leaves, attendance and performance reviews.", result: "60% less HR admin time", img: "https://images.unsplash.com/photo-1531403009284-440f080d1e12?w=1200&q=80&auto=format&fit=crop" },
  { title: "SwiftPOS", category: "POS", industry: "Retail", tech: ["React Native", "Node", "MongoDB"], desc: "Multi-branch POS with real-time inventory and cloud reporting.", result: "Deployed to 24 locations", img: "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=1200&q=80&auto=format&fit=crop" },
  ...
  { title: "Cloudlane SaaS", category: "SaaS Platforms", industry: "DevOps", tech: ["Next.js", "AWS", "Postgres"], desc: "B2B SaaS with billing, role-based access and admin dashboards.", result: "$1.2M ARR in year one", img: "https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?w=1200&q=80&auto=format&fit=crop" },
];
