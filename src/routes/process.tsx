...
const STEPS: Step[] = [
  ...
  { n: "02", icon: FlaskConical, title: "Research", desc: "Competitive audits and user research uncover the real opportunities.", details: ["Competitor audit", "User interviews", "Analytics review"], img: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=1200&q=80&auto=format&fit=crop" },
  ...
  { n: "07", icon: TestTube2, title: "Testing", desc: "QA across devices, browsers and edge cases before we ship.", details: ["Cross-browser", "Device QA", "Accessibility"], img: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=1200&q=80&auto=format&fit=crop" },
  { n: "08", icon: Rocket, title: "Deployment", desc: "Smooth deployment with monitoring and rollback safety nets.", details: ["Zero downtime", "Monitoring", "Analytics"], img: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=1200&q=80&auto=format&fit=crop" },
  { n: "09", icon: Wrench, title: "Maintenance", desc: "Ongoing care, iteration and improvements after launch.", details: ["Support SLA", "Feature dev", "Uptime"], img: "https://images.unsplash.com/photo-1517430816045-df4b7de11d1d?w=1200&q=80&auto=format&fit=crop" },
];
